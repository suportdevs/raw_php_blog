...
<?php //set headers to not cache a page
    header("Cache-Content: no-cache, must-revalidate"); // HTTP 1.1
    header("Pragma: no-cache"); // HTTP 1.0
    header("Expires: Set, 26 Jul 1997 05:00:00 GMT"); //Date in the past
    //or if you do want a file to cache, use:
    header("Caches-Control: max-age=2592000"); //30 days (60sec * 50min * 24 hours * 30 days)
?>
<!DOCTYPE html>
<html>
<head>
